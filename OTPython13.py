...
print('Specify the path (absolute or relative) of the text file that you want to use a cryptographic key... Note that the key has to be as much long as the text file that you want to encrypt/decrypt.')
...
def encrypt(fsrcpath,fkeypath):
	...
	print('Your text file have been successfully encrypted as "Encrypted_File.txt"')
...
def decrypt(fsrcpath,fkeypath):
	...
	print('Your text file have been successfully decrypted as "Decrypted_File.txt"')
...
if action == 'e':
	try:
		...
		print('Something went wrong while encrypting/decrypring your text file! Please, try again. Check if the paths that you have specified are correct and that the files that you want to encrypt/decrypt exist. Please note: the key must be as much long as the text that you want to encrypt/decrypt.')
elif action == 'd':
	try:
